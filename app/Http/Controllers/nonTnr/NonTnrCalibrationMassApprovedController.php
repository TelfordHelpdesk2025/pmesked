...
class NonTnrCalibrationMassApprovedController extends Controller
{
    ...
    public function index()
    {
        ...
        $query = NonTnrCalibrationReport::query();
        ...
        return Inertia::render('Calibration/NonTnrcalibrationReportMassApproved', [
            'reports' => $reports,
            'empData' => $empData,
        ]);
    }
    ...
    public function nonTnrapproveQA(Request $request)
    {
        ...
        NonTnrCalibrationReport::whereIn('id', $request->ids)->update([
